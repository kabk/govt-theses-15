...
class OpenGraph(dict):
    ...
    required_attrs = ['title', 'type', 'image', 'url', 'description', 'creator']
    ...
    def scrape_image(self, doc):
        ...
        if img_urls:
            ...
            return urljoin(self._url, local_img_url)
    ...
    def scrape_creator(self, doc):
        creator = doc.html.head.findAll(property='dc:creator')
        for c in creator:
            if c.has_attr(u'content'):
                return c[u'content']
